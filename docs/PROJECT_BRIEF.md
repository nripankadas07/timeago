        ...
        timeago exists to solve a narrow, inspectable developer-tooling problem:
        Human-readable relative-time formatting ("3 hours ago", "in 2 days"). Zero dependencies.
        ...
        Topics: datetime, formatter, human-readable, python, relative-time, timeago, zero-dependencies
